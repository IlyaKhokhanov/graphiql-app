export const ru = {
  ...
  'developers.ilya.description':
    'Фронтенд разработчик (React), который более 2 лет занимается разработкой Фронтенда. В этом приложении реализовал Регистрацию, Аутентификацию, Rest клиент и Историю, принимал активное участие в разработке Домашней страницы и пользовательского интерфейса.',
  ...
  'rest.param.description': 'Переменные можно использовать в body "{{имя переменной}}"',
  'rest.param.header': 'Переменные:',
  'rest.param.button': 'Добавить переменную',
  'rest.param.placeholder.key': 'Имя переменной',
  'rest.param.placeholder.value': 'Значение переменной',
